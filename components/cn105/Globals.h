...
static const uint8_t WIDEVANE[11] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x08, 0x0c, 0x80, 0x82, 0xaa, 0x28, 0x8c };
static const char* WIDEVANE_MAP[11] = { "←←", "←", "|", "→", "→→", "←→", "SWING", "INDIRECT", "AUTO", "DIRECT", "EVEN", "OFF" };
